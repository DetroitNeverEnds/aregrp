    ...
    return (
        <>
            <VerticalMainContainer
                ...
                align="center"
                justify="between"
                className={classNames(styles.hero, breakpointStyles.desktopOnly)}
            >
            ...
            <Container
                align="center"
                justify="between"
                className={classNames(styles.hero, breakpointStyles.mobileOnly)}
                gap="secondary"
            >
                <Flex direction="column" align="start" gap={24} fullWidth>
                    <Text variant="h2" color="gray-0" id="agents-hero-title">
                        {t('pages.agents.hero.title')}
                    </Text>
                    <Text variant="20-reg" color="gray-0">
                ...
                <PercentageIcon className={styles.hero__icon} />
                <Button
                    size="lg"
                    variant="outlined"
                    theme="dark"
...
export const Agents = () => {
    ...
    return (
        <Page>
            <Welcome scrollToFeedback={scrollToFeedback} />
            <VerticalMainContainer>
                <div className={styles.bc}>
                    <BreadCrumbs breadcrumbs={breadcrumbs} />
                </div>
                <Columns className={styles.columns}>
                    <div className={styles.columns__column}>
                        ...
                        {benefits.slice(0, 4).map(({ icon, text }, index) => (
                            <Flex key={index} align="start" gap={20} direction="row">
                    ...
                    <div className={styles.columns__column}>
                        ...
                        {benefits.slice(4).map(({ icon, text }, index) => (
                            <Flex key={index} align="start" gap={20} direction="row">
                                <Icon name={icon || 'sample'} size={32} color="primary-700" />
                                <Text variant="20-reg">{text}</Text>
                            </Flex>
