"""
Django settings for project an Aregrp.
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware',  # Для перевода ошибок и интерфейса
...
USE_L10N = True  # Локализация форматов дат, чисел и т.д.
...
# Email Settings (SMTP; задайте переменные в .env)
EMAIL_BACKEND = config('EMAIL_BACKEND', default='django.core.mail.backends.smtp.EmailBackend')
EMAIL_HOST = config('EMAIL_HOST', default='smtp.gmail.com')
EMAIL_PORT = config('EMAIL_PORT', cast=int, default=587)
EMAIL_USE_TLS = config('EMAIL_USE_TLS', cast=bool, default=True)
# Порт 465 (SMTPS): implicit TLS — True; порт 587: обычно False, используется USE_TLS/STARTTLS
EMAIL_USE_SSL = config('EMAIL_USE_SSL', cast=bool, default=False)
# Секунды на connect/send; без таймаута smtplib может долго «висеть» при плохой сети
EMAIL_TIMEOUT = config('EMAIL_TIMEOUT', cast=int, default=3)
...
#PAYMENTS
PAYMENTS_ACCOUNT_ID = config('PAYMENTS_ACCOUNT_ID', default='')
